...
#将YOUR DIR替换成你自己的目录
path_originalData = "/home/lipengcheng/local_codes/nnUNet/DATASET/nnUNet_raw/nnUNet_raw_data/Task10_Maiqi68_01/"
...
#这里为label文件中的多个标签，比如这里有血管、胆管、结石、肿块四个标签，名字可以按需要命名，包括背景
